    ...
    <>
      <div className="flex">
        <div className="flex-row">
          ...
          <div className="ml-12 mb-2 text-2xl font-semibold">
            React Tutorial in Hindi{" "}
          </div>
          <div className="flex">
            <img
              className="ml-12 h-10 rounded-full"
              alt="icon"
            ...
            <div className="bg-black text-white rounded-3xl pt-2 ml-10 font-semibold px-3 h-10 mt-2">
              Join
            </div>
            ...
            <div className="flex bg-slate-100 rounded-3xl pt-2 ml-32 font-semibold px-3 h-10 mt-2">
              <img
                className="h-5 w-5"
                src="https://cdn-icons-png.flaticon.com/128/9513/9513802.png"
                alt="like"
              />
              ...
              <img
                ...
                src="https://cdn-icons-png.flaticon.com/128/880/880561.png"
                alt="dislike"
              />
            </div>
